[CCode (gir_namespace = "SundayLLDB", gir_version = "1.0")]
namespace Sunday.LLDB {
	...
	public enum ASLR {
		...
		public static ASLR from_nick (string nick) throws Sunday.Error {
	...
	public enum Signal {
		...
		public static Signal from_nick (string nick) throws Sunday.Error {
	...
	public enum MachExceptionType {
		...
		public static MachExceptionType from_nick (string nick) throws Sunday.Error {
